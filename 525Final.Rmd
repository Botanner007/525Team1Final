...
We begin by evaluating our dataframe information.  Our data, Credit, is derived from a simulated dataset containing information on 400 observations of 12 variables.  The summary shows that Balance could contain a zero value for some observations, but no other variables  contain zeros, N/As or negative values. Since credit providers would primarily be interested in seeking insights pertaining to customers that carry a balance on their accounts, we will omit any observations that include zeros in the Balance variable. This new subset of the Credit data, called Credit2, will be used for fitting our models via a variety of methods, in order to determine the best fit and draw conclusions for our customer. 
...
Now to interpret what our data is trying to tell us that with every variable at a 0 value, the average salary is about 00001.37 dollars in the inverse scale. The intercept corresponds with a female assitant professor under the A discipline. When you adjust to Associate professor, the salary in inverse scale drops about .0000019 dollars. When you adjust for the rank of Professor instead, you see a decrease of about .0000048 dollars. When you adjust for discipline B, you see a drop .0000012 dollars in salary using the inverse scale. Finally when you adjust for male, you see a decrease of about .00000049 dollars in the inverse scale, of courese this adjustment does not have much significance when you test at the level of 5% and 1%. 
