...
While the variance is fairly consistent, we can clearly see the Balnace=0 values skewing the plots. We will test some basic transformations (sqrt and ^2, but no log because of the zeros) on the Balance to see if a better model fit can be obtained while including all of the observations (including Balance=0).
